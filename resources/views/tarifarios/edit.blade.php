...
@section('page_title', 'Editar Tarifa')
...
<div class="spgi-bg">
  <div class="container">
    ...
    <div class="d-flex align-items-center justify-content-between mb-4 max-w-800 mx-auto" style="max-width: 800px;">
        <div>
            <h1 class="h3 mb-1 fw-bold text-gradient">Editar Tarifa</h1>
            <p class="text-muted mb-0">Actualiza los datos del tipo de soporte.</p>
        </div>
        ...
        <form action="{{ route('tarifarios.update', $tarifario->id) }}" method="POST">
            ...
            <div class="row g-4 mb-4">
                    ...
                    <div class="input-group">
                        <select name="tipo_tarifario_id" id="tipo_tarifario_id" class="form-select" style="height: 48px; border-radius: 12px 0 0 12px;">
                            ...
                            @foreach($tipoSoportes as $tipo)
                                <option value="{{ $tipo->id }}" {{ old('tipo_tarifario_id', $tarifario->tipo_tarifario_id) == $tipo->id ? 'selected' : '' }}>{{ $tipo->nombre }}</option>
                            @endforeach
                        </select>
                ...
                <div class="col-12">
                    ...
                    <input type="text" name="descripcion" class="form-control" placeholder="Ej. Soporte Hardware, Entrenamiento..." required value="{{ old('descripcion', $tarifario->descripcion) }}">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="basico_int" class="form-control" placeholder="Ej. 600.00, VARIABLE, N/A" value="{{ old('basico_int', $tarifario->basico_int) }}">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="avanzado_int" class="form-control" placeholder="Ej. 1,000.00, VARIABLE, N/A" value="{{ old('avanzado_int', $tarifario->avanzado_int) }}">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="basico_ext" class="form-control" placeholder="Ej. 1,500.00, VARIABLE, N/A" value="{{ old('basico_ext', $tarifario->basico_ext) }}">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="avanzado_ext" class="form-control" placeholder="Ej. 2,500.00, VARIABLE, N/A" value="{{ old('avanzado_ext', $tarifario->avanzado_ext) }}">
                ...
                <div class="col-md-12">
                    ...
                    <input type="text" name="valor" class="form-control" placeholder="Ej. 500.00, VARIABLE..." value="{{ old('valor', $tarifario->valor) }}">
            ...
            <div class="d-flex justify-content-end">
                <button type="submit" class="btn btn-spgi">
                    <i class="bi bi-save me-2"></i> Actualizar Tarifa
                </button>
            </div>
        </form>
    </div>

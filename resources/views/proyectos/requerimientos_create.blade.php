...
<div class="container mt-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
      <div>
        <h3 class="m-0">Agregar Requerimiento de Proyecto</h3>
    ...
    <form action="{{ route('proyectos.requerimientos.store', $proyecto->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="mb-3">
            ...
            <select name="cliente_id" id="cliente_id" class="form-select" required>
                ...
                @foreach($clientes as $cliente)
                    <option value="{{ $cliente->id }}" {{ $cliente->id == old('cliente_id', $proyecto->cliente_id) ? 'selected' : '' }}>
                        {{ $cliente->nombre }}
                    </option>
                @endforeach
            </select>
        ...
        <div class="mb-3">
            ...
            <select name="requerimiento_cliente_id" id="requerimiento_cliente_id" class="form-select">
                ...
                @foreach($tareas as $t)
                    <option value="{{ $t->id }}" {{ $t->id == old('requerimiento_cliente_id', $selected_tarea_id) ? 'selected' : '' }}>
        ...
        <div class="mb-3">
            ...
            <small class="text-muted d-block mt-1" id="contacto_help">
                Seleccione un cliente para ver sus contactos o use el del proyecto.
            </small>
        </div>
        ...
        <div class="mb-3">
            ...
            <select name="tipo_soporte_id" class="form-select" required>
                ...
                @foreach($tiposSoporte as $tipo)
                    <option value="{{ $tipo->id }}" {{ $tipo->id == old('tipo_soporte_id', $proyecto->tipo_soporte_id) ? 'selected' : '' }}>
                        {{ $tipo->nombre }}
                    </option>
                @endforeach
            </select>
        ...
        <div class="mb-3">
            ...
            <select name="prioridad" class="form-select" required>
                <option value="5" class="text-danger fw-bold">5 - Muy Urgente</option>
                <option value="4" class="text-warning fw-bold">4 - Urgente</option>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Cargar contactos iniciales basados en el cliente heredado
    if (clienteSelect.value) {
        loadContactos(clienteSelect.value, "{{ old('contacto_id', $proyecto->contacto_id) }}");
    }

...
<div class="container py-5">
    <div class="form-container">
        <div class="d-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 fw-bold mb-0"><i class="bi bi-pencil-square me-2 text-primary"></i> Editar Proveedor: {{ $proveedor->nombre }}</h1>
        ...
        <form action="{{ route('proveedores.update', $proveedor->id) }}" method="POST" class="card-form animate__animated animate__fadeIn">
            @csrf
            @method('PUT')
                ...
                <div class="col-md-7">
                    <div class="input-group-custom">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="nombre" class="form-control" required placeholder="Ej: Importadora Global S.R.L." value="{{ old('nombre', $proveedor->nombre) }}">
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <label class="small text-muted mb-1">RNC / Cédula</label>
                                <input type="text" name="rnc" class="form-control" placeholder="001-00000-0" value="{{ old('rnc', $proveedor->rnc) }}">
                            </div>
                            <div class="col-md-6">
                                ...
                                <select name="categoria" class="form-select">
                                    ...
                                    <option value="Equipos" {{ $proveedor->categoria == 'Equipos' ? 'selected' : '' }}>Equipos</option>
                                    <option value="Mantenimiento" {{ $proveedor->categoria == 'Mantenimiento' ? 'selected' : '' }}>Mantenimiento</option>
                ...
                <div class="col-md-5">
                    <div class="input-group-custom">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="persona_contacto" class="form-control" placeholder="Nombre de quien atiende" value="{{ old('persona_contacto', $proveedor->persona_contacto) }}">
                        </div>
                        <div class="mb-3">
                            <label class="small text-muted mb-1">Teléfono</label>
                            <input type="text" name="telefono" class="form-control" placeholder="809-000-0000" value="{{ old('telefono', $proveedor->telefono) }}">
                        </div>
                        <div class="mb-0">
                            <label class="small text-muted mb-1">Correo Electrónico</label>
                            <input type="email" name="correo" class="form-control" placeholder="contacto@empresa.com" value="{{ old('correo', $proveedor->correo) }}">
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12">
                    <div class="input-group-custom">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="direccion" class="form-control" placeholder="Calle, Número, Ciudad..." value="{{ old('direccion', $proveedor->direccion) }}">
                        </div>
                        <div class="mb-0">
                            <label class="small text-muted mb-1">Observaciones / Detalles Adicionales</label>
                            <textarea name="observaciones" class="form-control" rows="3" placeholder="Escribe aquí cualquier detalle relevante sobre este proveedor...">{{ old('observaciones', $proveedor->observaciones) }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="text-end mt-4">
                <button type="submit" class="btn btn-save">
                    <i class="bi bi-check-circle me-2"></i> Actualizar Proveedor
                </button>
            </div>
        </form>
    </div>
